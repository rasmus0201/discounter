...
class DiscountTableTest extends TestCase
{
    ...
    public function test_get_table_percentage_ruleset()
    {
        ...
        $table = $discountTable->hideDiscountFreeRows()->get($this->basePrice, $rules);
    ...
    public function test_show_discount_free_rows()
    {
        $rules = [
            [
                'operator' => '>=',
        ...
        $table = $discountTable->showDiscountFreeRows()->get($this->basePrice, $rules);

        $this->assertCount(6, $table);
        $this->assertEquals(0, $table[0]['amount']);
        $this->assertEquals(0, $table[1]['amount']);
        $this->assertEquals(10, $table[2]['amount']);
        $this->assertEquals(10, $table[3]['amount']);
        $this->assertEquals(10, $table[4]['amount']);
        $this->assertEquals(15, $table[5]['amount']);
    }
